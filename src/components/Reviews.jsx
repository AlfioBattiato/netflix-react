                            ...
                            {reviews.slice(0, number).map((e, index) => (
                                <div key={e.id}>
                                    <div className="mt-3 d-flex align-items-center gap-2">
                                        <img loading="lazy" src={e.author_details.avatar_path ? `https://image.tmdb.org/t/p/original/${e.author_details.avatar_path}.webp ` : "/assets/avatar.jpg"} style={{ width: "3rem", objectFit: "cover", height: "3rem", borderRadius: "50%" }} alt="avatar" />
