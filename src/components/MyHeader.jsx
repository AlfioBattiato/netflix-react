              ...
              <Carousel.Caption>
                <div className="d-flex gap-5 align-items-center">
                  <div className="text-start">
                    <h1 className="bebas text-start text-light">{film.title?film.title:film.original_name}</h1>
                    ...
                    <p className="text-red fw-semibold pt-2 m-0">
                      Release date{" "}
                      <span className="text-white">{film.release_date?film.release_date:film.first_air_date}</span>
                    </p>
                    ...
                    <div>
                      ...
                      >
                        <g>
                          ...
                          <path d="M109.699,78.969c-1.876,1.067-3.035,3.059-3.035,5.216v131.674c0,3.314,2.687,6,6,6s6-2.686,6-6V94.74l88.833,52.883l-65.324,42.087c-2.785,1.795-3.589,5.508-1.794,8.293c1.796,2.786,5.508,3.59,8.294,1.794l73.465-47.333c1.746-1.125,2.786-3.073,2.749-5.15c-0.037-2.077-1.145-3.987-2.93-5.05L115.733,79.029 C113.877,77.926,111.575,77.902,109.699,78.969z" />
                        </g>
                      </svg>
                    </div>
